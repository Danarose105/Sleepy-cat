...
lib.ssMetadata = [
		{name:"Catlookingtosleep_atlas_1", frames: [[0,0,1706,993]]},
		{name:"Catlookingtosleep_atlas_2", frames: [[0,0,1536,1078]]},
		...
		{name:"Catlookingtosleep_atlas_6", frames: [[0,414,1442,314],[0,1046,771,541],[773,1046,779,473],[0,0,1288,412],[0,1589,1078,329],[0,730,1442,314],[1080,1521,878,329],[1444,0,499,474],[1554,476,452,521]]},
		{name:"Catlookingtosleep_atlas_7", frames: [[1108,571,364,299],[0,626,369,294],[1474,571,364,299],[1407,228,323,341],[0,320,446,110],[371,626,456,179],[1407,0,568,226],[371,807,495,83],[0,484,1106,140],[723,0,361,482],[0,0,721,318],[1108,452,174,62],[1086,0,319,450]]}
];
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(1.3,-5.45);
	...
	this.shape_1.setTransform(0.861,-5.95);

	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#E9F6FD").s().p("");
	this.shape_2.setTransform(1.3,-5.45);
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_2},{t:this.shape_1},{t:this.shape,p:{y:-5.45}}]}).to({state:[{t:this.shape_4},{t:this.shape_3},{t:this.shape,p:{y:-6.45}}]},1).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape,p:{y:-5.45}}]},1).wait(2));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-67.7,-35.9,138,60);
...
if (reversed == null) { reversed = false; }
	...
	// topleg
	this.instance = new lib.catrightfoot();
	this.instance.setTransform(-118.4,96.05,2.1513,2.9127,59.9985,0,0,8.7,14.2);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({x:-103.1},20).to({x:-137.3},12).wait(18));

	// wall
	this.instance_1 = new lib.CachedBmp_35();
	this.instance_1.setTransform(-296.4,93.1,0.3772,0.3772);

	this.timeline.addTween(cjs.Tween.get(this.instance_1).wait(50));

	// legs
	this.instance_2 = new lib.catleftfoot();
	this.instance_2.setTransform(54.6,56,2.3923,2.4893,29.9993,0,0,13.2,21);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).to({regX:13.1,rotation:34.0216,x:54.95,y:56.1},21).to({regX:13.2,rotation:-10.9777,x:55.25,y:56},21).wait(8));

	// background
	this.instance_3 = new lib.CachedBmp_36();
	this.instance_3.setTransform(-430,-218.65,0.3772,0.3772);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(669.05,657.1,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get(this.instance).to({_off:true},1).wait(73));

	// sky_bg
	this.instance_1 = new lib.garden_bg("synched",0);
	this.instance_1.setTransform(730.85,716.05,1,1,0,0,0,388.2,134.8);

	this.instance_2 = new lib.CachedBmp_26();
	this.instance_2.setTransform(339.3,369.1,0.5,0.5);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.instance_1}]}).to({state:[]},1).wait(73));
...
if (reversed == null) { reversed = false; }
	...
	// grass_button
	this.instance = new lib.restart("synched",0);
	this.instance.setTransform(376.5,298.6,1.9231,2.3793,0,0,0,52.1,8.8);

	this.instance_1 = new lib.garden_bg("synched",0);
	this.instance_1.setTransform(361.2,343.2,0.9176,1,0,0,0,388.2,134.8);

	this.instance_2 = new lib.grass("synched",0);
	this.instance_2.setTransform(356.2,438.4,1,1.3093,0,0,0,356.2,38.9);

	this.shape = new cjs.Shape();
	this.shape.graphics.f("#CBE9FA").s().p("Eg3mAlvMAAAhLdMBvNAAAMAAABLdg");
	this.shape.setTransform(356.575,241.475);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.instance_2},{t:this.instance_1},{t:this.instance}]}).to({state:[]},1).wait(47));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(0,0,717.5,489.1);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_2.setTransform(-296.45,93.1,0.3772,0.3772);

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(110).to({_off:true},1).wait(16));

	// sunray
	this.instance_3 = new lib.sunrays("synched",0);
	this.instance_3.setTransform(350.35,-208.9,1,1,0,0,0,81.1,51.9);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(32).to({_off:false},0).to({regX:80.8,regY:51.5,scaleX:8.098,scaleY:8.5867,x:269.5,y:-212.3},72).to({startPosition:0},6).to({_off:true},1).wait(16));

	// background
	this.instance_4 = new lib.CachedBmp_14();
	this.instance_4.setTransform(-299,24.75,0.3772,0.3772);

	this.instance_5 = new lib.grass("synched",0);
	this.instance_5.setTransform(39.25,177.45,1,1.3505,0,0,0,356.2,38.9);

	this.instance_6 = new lib.CachedBmp_13();
	this.instance_6.setTransform(-350.95,-153.85,0.3772,0.3772);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]}).to({state:[{t:this.instance_6},{t:this.instance_5},{t:this.instance_4}]},110).to({state:[]},1).wait(16));

	this._renderFirstFrame();

}).prototype = p = new cjs.MovieClip();
p.nominalBounds = new cjs.Rectangle(-384.8,-654.5,1313.5,891.3);
...
if (reversed == null) { reversed = false; }
	...
	this.streamSoundSymbolsList[306] = [{id:"mixkitmorningsoundswavwav",startFrame:306,endFrame:479,loop:1,offset:0}];
	...
	this.frame_306 = function() {
		var soundInstance = playSound("mixkitmorningsoundswavwav",0);
		this.InsertIntoSoundStreamData(soundInstance,306,479,1);
		createjs.Sound.registerSound("C:\Users\97258\Desktop\לימודים\שנה א'- סמסטר ב'\מבוא לתכנות,אינטראקציה ואנימציה\sounds_Storyboard\mixkit-morningsounds wav.wav","morningsounds");
		createjs.Sound.play("morningsounds");
	}
